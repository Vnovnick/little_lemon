...
export default function About() {
  return (
    <section className="w-full max-w-[1100px] mx-auto flex 820:flex-row flex-col items-center font-display my-20 gap-10">
      <article>
      ...
      <section className="grid 820:w-full max-w-[700px] 820:h-[450px]">
        <img
          alt="Little Lemon Owners 1"
          className="col-start-1 row-start-1 object-scale-down w-full max-w-[450px] 820:ml-auto"
          src={chefs1}
        />
        <img
          alt="Little Lemon Owners 2"
          className="col-start-1 row-start-2 820:row-start-1 object-scale-down w-full max-w-[450px] mt-auto"
          src={chefs2}
        />
      </section>
    </section>
